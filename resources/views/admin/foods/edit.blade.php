...
@section('content')
    <div class="container mt-5">
        <h1 class="text-center pb-3">Изменить блюдо</h1>
        <form action="{{ route('admin.foods.update', ['food' => $food])}}" method="post" enctype="multipart/form-data">
            @method('put')
            @csrf
            ...
            <div class="form-group mt-3">
                <div class="custom-file ">
                    <img src="{{asset('/storage/' . $food->picture)}}" alt="{{$food->picture}}" style="width:50px;height:50px;">
        ...
        <button  type="submit" class="btn btn-warning mt-3">
            <a href="{{route('admin.foods.index')}}">Назад</a>
        </button>
    </div>
@endsection
